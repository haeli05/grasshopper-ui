...
interface IJupiterFormProps {
  ...
  const JupiterBenchmark: FunctionComponent<IJupiterFormProps> = (props) => {
      ...
      <div className="max-w-full md:max-w-lg">
        ...
        <div className="mb-2">
          ...
          <select
            ...
            value={props.inputMint?.toBase58()}
            onChange={(e) => {
        ...
        <div className="mb-2">
          ...
          <select
            ...
            name="outputMint"
            className="mt-1 bg-neutral block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
            value={props.outputMint?.toBase58()}
            onChange={(e) => {
              const pbKey = new PublicKey(e.currentTarget.value);
              if (pbKey) {
                setFormValue((val) => ({
  ...
  export default JupiterBenchmark;
